...
class ThemePageTemplate
{
    ...
    public function __construct($data)
    {
        ...
        $this->ThemeName = is_child_theme() ? sprintf(/* translators: %s are theme names */__("%s and %s", 'sonoran'), $this->Theme, $this->ParentName) : $this->Theme;
        $this->PremiumText = is_child_theme() ? sprintf(/* translators: %s are theme names */__("Unlock all features by upgrading to the premium edition of %s and its parent theme %s.", 'sonoran'), $this->Theme, $this->ParentName) : sprintf(/* translators: %s is a theme name */__("Unlock all features by upgrading to the premium edition of %s.", 'sonoran'), $this->Theme);
        ...
        $base_features = array(
            array(
                'title' => __("Fully Search Engine Optimized", "sonoran"),
                'base' => true,
                'icon' => "img-icon-8.png",
                'description' => __("Get free traffic by ranking #1 on Google with the lightning-fast & SEO-optimized premium version.", "sonoran"),
                'source' => 'seo'
            ),
            array(
                'title' => __("Page Speed Optimized", "sonoran"),
                'base' => true,
                'icon' => "img-icon-6.png",
                'description' => __("Unlock maximum speed with the premium version. It loads in less than 0.3 seconds. ", "sonoran"),
                'source' => 'speed'
            ),
            array(
                'title' => __("Customize Everything", "sonoran"),
                'base' => true,
                'icon' => "img-icon-7.png",
                'description' => __("Customize the design to fit your brand or style with our easy-to-use customization options.", "sonoran"),
                'source' => 'customization'
            ),
            array(
                'title' => __("E-commerce Compatibility", "sonoran"),
                'base' => true,
                'icon' => "img-icon-5.png",
                'description' => __("Create your online store easily. The premium version is compatible with all popular e-commerce plugins.", "sonoran"),
                'source' => 'ecommerce'
            ),
            array(
                'title' => __("Customer Support & Documentation", "sonoran"),
                'base' => true,
                'icon' => "img-icon-4.png",
                'description' => __("Benefit from our comprehensive documentation and dedicated support team, always ready to help.", "sonoran"),
                'source' => 'support'
            ),
            array(
                'title' => __("Works With All Page Builders", "sonoran"),
                'base' => true,
                'icon' => "img-icon-3.png",
                'description' => __("Brizy, Elementor, Divi Builder, Beaver Builder - you name it. Every page builder plugin is compatible.", "sonoran"),
                'source' => 'page_builders'
            ),
            array(
                'title' => __("1-Click Starter Content Import", "sonoran"),
                'base' => true,
                'icon' => "img-icon-2.png",
                'description' => __("Get started easily with our one-click demo content import feature. Get your website up and running in seconds.", "sonoran"),
                'source' => 'starter_content'
            ),
            array(
                'title' => __("Premium Designs, Patterns & Layouts", "sonoran"),
                'base' => true,
                'icon' => "img-icon-1.png",
                'description' => __("Access all the premium layouts and designs perfect for any niche or industry.", "sonoran"),
                'source' => 'designs'
            ),
            array(
                'title' => __("Works On All Devices And Browsers", "sonoran"),
                'base' => true,
                'icon' => "devices-duotone.svg",
                'description' => __("The premium version looks perfect everywhere, from desktop to mobile, and in every browser.", "sonoran"),
                'source' => 'devices'
            ),
            array(
                'title' => __("AMP Compatible And Mobile Ready", "sonoran"),
                'base' => true,
                'icon' => "fse_icon_mobile.svg",
                'description' => __("Stay ahead with Accelerated Mobile Pages (AMP) compatibility.", "sonoran"),
                'source' => 'amp'
            ),
            array(
                'title' => __("GDPR Compliant", "sonoran"),
                'base' => true,
                'icon' => "shield-check-duotone.svg",
                'description' => __("Our premium version comes fully compliant, giving you peace of mind about user data protection and privacy.", "sonoran"),
                'source' => 'gdpr'
            ),
            array(
                'title' => __("Frequent Updates", "sonoran"),
                'base' => true,
                'icon' => "arrows-clockwise-duotone.svg",
                'description' => __("Our premium version provides frequent enhancements for security, performance, and features.", "sonoran"),
                'source' => 'updates'
            ),
            array(
                'title' => __("Child Themes", "sonoran"),
                'base' => true,
                'icon' => "img-2.png",
                'description' => __("Use child themes to make modifications without affecting the parent theme's code, ensuring smooth updates.", "sonoran"),
                'source' => 'child_themes'
            ),
            array(
                'title' => __("WordPress blocks", "sonoran"),
                'base' => true,
                'icon' => "stack-duotone.png",
                'description' => __("Use our many custom WordPress Gutenberg blocks for every purpose!", "sonoran"),
                'source' => 'blocks'
            ),
            array(
                'title' => __("WordPress patterns", "sonoran"),
                'base' => true,
                'icon' => "grid-nine-duotone.png",
                'description' => __("Take advantage of the 400+ beautiful patterns for every type of website.", "sonoran"),
                'source' => 'patterns'
            ),
            array(
                'title' => __("Elementor sections", "sonoran"),
                'base' => true,
                'icon' => "img-1.png",
                'description' => __("Access 300+ pre-built Elementor sections and build beautiful sites, fast.", "sonoran"),
                'source' => 'elementor'
            )
        );
                ...
                <div class="spt-theme-settings-wrapper-main-content">
                    ...
                    <div class="spt-theme-settings-wrapper-main-content-section">
                        <div class="spt-theme-settings-wrapper-main-content-section-top">
                            ...
                            <?php else : ?>
                                <a class="spt-theme-settings-headline-link" href="<?php echo esc_url(admin_url('customize.php')); ?>"><?php esc_html_e("Go To Customizer", 'sonoran'); ?></a>
                            <?php endif; ?>
                        </div>
                            ...
                            <div class="spt-theme-settings-content-getting-started-wrapper">
                                <div class="spt-theme-settings-content-item">
                                    ...
                                    <div class="spt-theme-settings-content-item-content">
                                        ...
                                        <?php else: ?>
                                            <a class="spt-theme-settings-content-item-button" href="<?php echo esc_url(admin_url('nav-menus.php')); ?>"><?php esc_html_e("Go to Menus", "sonoran"); ?></a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="spt-theme-settings-content-item">
                                    <div class="spt-theme-settings-content-item-header">
                                        ...
                                        <?php else: ?>
                                            <div class="spt-theme-settings-content-item-headline">
                                                <?php esc_html_e("Add Widgets", 'sonoran'); ?>
                                            </div>
                                            <p><?php esc_html_e("Add and customize widgets in any widget space.", 'sonoran'); ?></p>
                                        <?php endif; ?>
                                    </div>
                                    <div class="spt-theme-settings-content-item-content">
                                        <?php if ($this->Type === 'block') : ?>
                                            <a class="spt-theme-settings-content-item-button" href="<?php echo esc_url(admin_url('site-editor.php')); ?>"><?php esc_html_e("Go To Site Editor", 'sonoran'); ?></a>
                                        <?php else: ?>
                                            <a class="spt-theme-settings-content-item-button" href="<?php echo esc_url(admin_url('widgets.php')); ?>"><?php esc_html_e("Go to Widgets", 'sonoran'); ?></a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="spt-theme-settings-content-item">
                                    ...
                                    <div class="spt-theme-settings-content-item-content">
                                        <?php if ($this->Type === 'block') : ?>
                                            <a class="spt-theme-settings-content-item-button" href="<?php echo esc_url(admin_url('site-editor.php')); ?>"><?php esc_html_e("Go To Site Editor", 'sonoran'); ?></a>
                                        <?php else: ?>
                                            <a class="spt-theme-settings-content-item-button" href="<?php echo esc_url(admin_url('customize.php')); ?>"><?php esc_html_e("Go To Customizer", 'sonoran'); ?></a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                    ...
                    <div class="spt-theme-settings-wrapper-main-content-section">
                        <div class="spt-theme-settings-wrapper-main-content-section-top">
                            ...
                            <a class="spt-theme-settings-headline-link" href="<?php echo esc_url($this->ThemeLink . "?su_source=theme_settings_unlock_all"); ?>"><?php esc_html_e("Unlock All Features", 'sonoran'); ?></a>
                        </div>
                ...
                <div class="spt-theme-settings-wrapper-sidebar">
                    ...
                    <div class="spt-theme-settings-wrapper-sidebar-item">
                        ...
                        <div class="spt-theme-settings-wrapper-sidebar-item-content">
                            ...
                            <a href="<?php echo esc_url($this->ThemeLink . "?su_source=theme_settings_view_premium"); ?>" target="_blank" class="button button-primary"><?php esc_html_e("View Premium Version", 'sonoran'); ?></a>
                        </div>
                    </div>
                    ...
                    <div class="spt-theme-settings-wrapper-sidebar-item">
                        ...
                        <div class="spt-theme-settings-wrapper-sidebar-item-content">
                            ...
                            <a href="<?php echo esc_url($this->ContactLink); ?>" target="_blank" class="button"><?php esc_html_e("Contact Support", 'sonoran'); ?></a>
                        </div>
                    </div>
                    ...
                    <div class="spt-theme-settings-wrapper-sidebar-item">
                        ...
                        <div class="spt-theme-settings-wrapper-sidebar-item-content">
                            ...
                            <a href="<?php echo esc_url('https://wordpress.org/support/theme/' . get_stylesheet() . '/reviews/#new-post'); ?>" target="_blank" class="button"><?php esc_html_e("Leave a Review", 'sonoran'); ?></a>
                        </div>
                    </div>
