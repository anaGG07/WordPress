        		...
        		<div class="notice-content">
	        		<div class="notice-holder">
	                       ...
	                       <a href="<?php echo esc_url( GENERAL_FOOD_STORE_NOTICE_BUY_NOW ); ?>" target="_blank" id="go-pro-button" class="button admin-button buy-now-button"><?php echo __('Buy Now ', 'general-food-store'); ?></a>
	                        ...
	                        <a href="<?php echo esc_url( GENERAL_FOOD_STORE_DOC_URL ); ?>" target="_blank" id="doc-button" class="button admin-button bundle-button"><?php echo __('Free Documentation', 'general-food-store'); ?></a>
	            	</div>
	            </div>
